...
class ProfilsControllerTest < ActionController::TestCase
  ...
  test "should create profil" do
    assert_difference('Profil.count') do
      post :create, profil: { date: @profil.date, mail: @profil.mail, nom: @profil.nom, prenom: @profil.prenom, role: @profil.role }
    end
  ...
  test "should update profil" do
    patch :update, id: @profil, profil: { date: @profil.date, mail: @profil.mail, nom: @profil.nom, prenom: @profil.prenom, role: @profil.role }
    assert_redirected_to profil_path(assigns(:profil))
  end
